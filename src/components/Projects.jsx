...
const projects = [
  ...
  {
    id: '05',
    title: 'Mert Ozkan — Portfolio',
    category: 'Portfolio / Personal',
    year: '2026',
    desc: 'A typography-led personal portfolio — “software written like a letter to someone careful.” Editorial hero with a dimensional 3D backdrop, a particle-synthesis side panel built with GLSL and Three.js, and a deliberate, restrained layout that lets the work speak.',
    tags: ['Next.js', 'React', 'Three.js', 'GLSL', 'Tailwind CSS'],
    bar: '#bef264',
    previewBg: 'linear-gradient(145deg, #0a0a08 0%, #020202 100%)',
    preview: 'portfolio',
    thumbnail: '/projects/portfolio.jpg',
    live: 'https://mertozkan-portfolio.vercel.app',
    github: '#',
  },
  {
    id: '06',
    title: 'MCO Driving School',
    category: 'Local Service / Driving',
    year: '2026',
    desc: 'A second-take on the driving-school brief — “driving lessons paced like a letter to someone careful.” Editorial dark hero over an automotive product render, transparent block-of-10 pricing, an availability rail, and a Book-a-Lesson flow tuned for East London learners.',
    tags: ['Next.js', 'React', 'Tailwind CSS', 'Three.js'],
    bar: '#bef264',
    previewBg: 'linear-gradient(145deg, #050505 0%, #020202 100%)',
    preview: 'agency',
    thumbnail: '/projects/driving-school.jpg',
    live: 'https://driving-school-pi-five.vercel.app',
    github: '#',
  },
  {
    id: '07',
